...
const EditUserModal = ({ onCancel, user }: Props) => {
  ...
  return (
    <div className="fixed h-screen w-screen  left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center">
      <div
        className={`absolute transform animation-forwards text-second bg-third bg-opacity-50 opacity-80 h-[20em] w-[19em] xl:w-[36em] flex flex-col rounded-2xl justify-center border-white border-2 items-center gap-4
      ...
      >
        ...
        <div className="flex w-full mt-4 justify-center gap-2">
          <button className="bg-white text-main border border-main rounded-xl px-6 py-2 font-medium">Yes</button>
